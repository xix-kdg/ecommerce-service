...
public class ProductTestData {
    ...
    public static List<Product> createDefaultProductList() {
        return List.of(
    ...
    public static Product createNewProduct() {
        return new Product("AeroStream Wireless", null, "Headphones", "Sonic", "Electronics",
                "img.jpg", new BigDecimal("100"), 10, LocalDateTime.now(), true);
    }

    public static List<Product> createNewProductList() {
        return List.of(
                new Product("AeroStream Wireless", null, "Headphones", "Sonic", "Electronics", "img1.jpg", new BigDecimal("149.99"), 12, LocalDateTime.now(), true),
                new Product("ErgoBack Mesh", null, "Office Chair", "SitWell", "Furniture", "img2.jpg", new BigDecimal("249.50"), 4, LocalDateTime.now(), true),
                new Product("Apex Runner X", null, "Running Shoes", "Strider", "Apparel", "img3.jpg", new BigDecimal("120.00"), 24, LocalDateTime.now(), true)
        );
    }
}
